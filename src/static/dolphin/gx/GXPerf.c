...
void GXSetGPMetric(GXPerf0 perf0, GXPerf1 perf1)
{
    ...
    CHECK_GXBEGIN(112, "GXSetGPMetric");
    ...
    case GX_PERF0_NONE:
        break;
    default:
        ASSERTMSGLINE(172, 0, "GXSetGPMetric: Invalid GXPerf0 metric name");
        break;
    }
    ...
    case GX_PERF1_NONE:
        break;
    default:
        ASSERTMSGLINE(222, 0, "GXSetGPMetric: Invalid GXPerf1 metric name");
        break;
    }
    ...
    default:
        ASSERTMSGLINE(480, 0, "GXSetGPMetric: Invalid GXPerf0 metric name");
        break;
    }
    ...
    default:
        ASSERTMSGLINE(625, 0, "GXSetGPMetric: Invalid GXPerf1 metric name");
        break;
    }
...
void GXReadGPMetric(u32 *cnt0, u32 *cnt1)
{
    ...
    ASSERTMSGLINE(652, !gx->inDispList, "GXReadGPMetric: don't use in a display list");
    ...
    case GX_PERF0_NONE:
        *cnt0 = 0;
        break;
    default:
        ASSERTMSGLINE(725, 0, "GXReadGPMetric: Invalid GXPerf0 metric name");
        *cnt0 = 0;
        break;
    }
    ...
    case GX_PERF1_NONE:
        *cnt1 = 0;
        break;
    default:
        ASSERTMSGLINE(784, 0, "GXReadGPMetric: Invalid GXPerf1 metric name");
        *cnt1 = 0;
        break;
    }
}
...
void GXClearGPMetric(void)
{
    ...
    ASSERTMSGLINE(807, !gx->inDispList, "GXClearGPMetric: don't use in a display list");
    reg = 4;
    __cpReg[2] = reg;
}
...
void GXReadMemMetric(u32 *cp_req, u32 *tc_req, u32 *cpu_rd_req, u32 *cpu_wr_req, u32 *dsp_req, u32 *io_req, u32 *vi_req, u32 *pe_req, u32 *rf_req, u32 *fi_req)
{
    ...
    ASSERTMSGLINE(900, !gx->inDispList, "GXReadMemMetric: don't use in a display list");
...
{
    ASSERTMSGLINE(957, !gx->inDispList, "GXClearMemMetric: don't use in a display list");
...
//     ASSERTMSGLINE(1013, !gx->inDispList, "GXReadPixMetric: don't use in a display list");
...
void GXClearPixMetric(void)
{
    ...
    CHECK_GXBEGIN(1057, "GXClearPixMetric");
...
void GXSetVCacheMetric(GXVCachePerf attr)
{
    ...
    SET_REG_FIELD(1088, gx->perfSel, 4, 0, attr);
    GX_WRITE_SOME_REG4(8, 0x20, gx->perfSel, -12);
    reg = 1;
...
void GXInitXfRasMetric(void)
{
    ...
    CHECK_GXBEGIN(1165, "GXInitXfRasMetric");
...
#pragma scheduling off // necessary evil apparently
