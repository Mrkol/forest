...
struct __GXData_struct {
    // total size: 0x4F4
    u16 vNumNot; // offset 0x0, size 0x2
    u16 bpSentNot; // offset 0x2, size 0x2
    u16 vNum; // offset 0x4, size 0x2
    u16 vLim; // offset 0x6, size 0x2
    ...
    GXTexRegionCallback texRegionCallback; // offset 0x410, size 0x4
