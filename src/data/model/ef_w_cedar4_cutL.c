...
Vtx ef_w_cedar4_cutL_v[] = {
#include "assets/ef_w_cedar4_cutL_v.inc"
};

Gfx ef_w_cedar4_cutL_leaf_model[] = {
    gsSPDisplayList(ef_w_cedar_leaf_modeset),
    gsSPVertex(ef_w_cedar4_cutL_v, 32, 0),
...
Gfx ef_w_cedar4_cutL_trunk_model[] = {
    ...
    gsSPVertex(&ef_w_cedar4_cutL_v[47], 6, 0),
    gsSPNTrianglesInit_5b(4, 0, 1, 2, 1, 3, 2, 1, 4, 3),
    gsSPNTriangles_5b(1, 5, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0),
    gsSPEndDisplayList(),
};

cKF_Joint_R_c cKF_je_r_ef_w_cedar4_cutL_tbl[] = {
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { -750, 0, 0 } },
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { ef_w_cedar4_cutL_trunk_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 2000, 0, 0 } },
    { ef_w_cedar4_cutL_leaf_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 4750, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_ef_w_cedar4_cutL = { ARRAY_COUNT(cKF_je_r_ef_w_cedar4_cutL_tbl), 2,
                                               cKF_je_r_ef_w_cedar4_cutL_tbl };
