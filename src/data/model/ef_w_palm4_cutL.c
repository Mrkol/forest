...
Gfx ef_w_palm4_cutL_trunk_model[] = {
    ...
    gsSPVertex(&ef_w_palm4_cutL_v[32], 6, 0),
...
cKF_Skeleton_R_c cKF_bs_r_ef_w_palm4_cutL = { ARRAY_COUNT(cKF_je_r_ef_w_palm4_cutL_tbl), 2,
                                              cKF_je_r_ef_w_palm4_cutL_tbl };
