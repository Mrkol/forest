...
cKF_Joint_R_c cKF_je_r_hnd_tbl[] = { { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 789, 722, 135 } },
                                     ...
                                     { body_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 3430, 652, -223 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 468, 625, -360 } },
                                     { NULL, 2, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 915, 0, 0 } },
                                     { oyaT_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 2069, -931, 136 } },
                                     { oya_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 2436, -1684, 136 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 1577, 668, 0 } },
                                     { NULL, 2, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 879, 0, 0 } },
                                     { hitoT_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 999, -21, 2 } },
                                     { hito_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 1853, -16, -223 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 1663, 136, 0 } },
                                     { NULL, 2, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 889, 0, 0 } },
                                     { nakaT_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 906, 516, -20 } },
                                     { naka_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 1767, 516, -223 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 1612, -392, 0 } },
                                     { NULL, 2, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 849, 0, 0 } },
                                     { kusuriT_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 994, 1039, 1 } },
                                     { kusuri_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 1824, 1033, -223 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 1462, -879, 0 } },
                                     { NULL, 2, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
                                     { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 743, 0, 0 } },
                                     { koT_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 1252, 1524, 58 } },
                                     { ko_hnd_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 1968, 1531, -223 } } };
