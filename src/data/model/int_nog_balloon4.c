...
u16 int_nog_balloon4_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/int_nog_balloon4_pal.inc"
};

static u8 tol_balloon1_wire_tex_txt[] = {
#include "assets/int_nog_balloon4/tol_balloon1_wire_tex_txt.inc"
};

u8 int_nog_balloon4_weight_tex_txt[] = {
#include "assets/int_nog_balloon4_weight_tex_txt.inc"
};

u8 int_nog_balloon4_head_tex_rgb_ia8[] = {
#include "assets/int_nog_balloon4_head_tex_rgb_ia8.inc"
};

Vtx int_nog_balloon4_v[] = {
#include "assets/int_nog_balloon4_v.inc"
};

Gfx int_nog_balloon4_weight_model[] = {
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_ON),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPLoadTLUT_Dolphin(15, 16, 1, int_nog_balloon4_pal),
    ...
    gsSPVertex(&int_nog_balloon4_v[70], 28, 0),
...
Gfx int_nog_balloon4_b_model[] = {
    ...
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
    gsSPVertex(&int_nog_balloon4_v[44], 4, 0),
    gsSPMatrix(&anime_6_mdl[2], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, tol_balloon1_wire_tex_txt),
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
    gsSPVertex(&int_nog_balloon4_v[48], 14, 4),
...
Gfx int_nog_balloon4_c_model[] = {
    ...
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
    gsSPVertex(&int_nog_balloon4_v[26], 4, 0),
    gsSPMatrix(&anime_6_mdl[3], G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_I, G_IM_SIZ_4b, 16, 16, tol_balloon1_wire_tex_txt),
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_CLAMP, GX_CLAMP, 0, 0),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
    gsSPVertex(&int_nog_balloon4_v[30], 14, 4),
...
Gfx int_nog_balloon4_head_model[] = {
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_TEX_EDGE2),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_IA, G_IM_SIZ_8b, 32, 32, int_nog_balloon4_head_tex_rgb_ia8),
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 0, GX_REPEAT, GX_REPEAT, 1, 1),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_TEXTURE_GEN | G_SHADING_SMOOTH |
                         G_DECAL_LEQUAL),
    gsSPVertex(int_nog_balloon4_v, 26, 0),
...
u8 cKF_ckcb_r_int_nog_balloon4_tbl[] = { 0, 0, 3, 3, 3, 3 };

s16 cKF_kn_int_nog_balloon4_tbl[] = { 5, 5, 4, 5, 5, 6, 4, 5 };

s16 cKF_c_int_nog_balloon4_tbl[] = { 0, 0, 0, 0, 0, 0, 0, -900, 0, 0, 0, 0, 0 };

s16 cKF_ds_int_nog_balloon4_tbl[] = { 1,  -50,  10,   19, 15,   144,  34, 47,   -54, 60, -50,  -19,  61, -50,  -10,
...
cKF_Animation_R_c cKF_ba_r_int_nog_balloon4 = { cKF_ckcb_r_int_nog_balloon4_tbl,
                                                cKF_ds_int_nog_balloon4_tbl,
                                                cKF_kn_int_nog_balloon4_tbl,
                                                cKF_c_int_nog_balloon4_tbl,
                                                -1,
                                                61 };

cKF_Joint_R_c cKF_je_r_int_nog_balloon4_tbl[] = {
    { int_nog_balloon4_weight_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 500, 0 } },
    { int_nog_balloon4_a_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { int_nog_balloon4_b_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 875, 0, 0 } },
    { int_nog_balloon4_c_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 875, 0, 0 } },
    { int_nog_balloon4_head_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 875, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_int_nog_balloon4 = { ARRAY_COUNT(cKF_je_r_int_nog_balloon4_tbl), 5,
                                               cKF_je_r_int_nog_balloon4_tbl };
