...
Gfx ef_f_tree4_cutL_leaf_model[] = {
    ...
    gsSPVertex(ef_f_tree4_cutL_v, 10, 0),
...
Gfx ef_f_tree4_cutL_trunk_model[] = {
    ...
    gsSPVertex(&ef_f_tree4_cutL_v[10], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP2Triangles(2, 1, 4, 0, 1, 5, 4, 0),
    gsSPEndDisplayList(),
};

cKF_Joint_R_c cKF_je_r_ef_f_tree4_cutL_tbl[] = {
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { -750, 0, 0 } },
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { ef_f_tree4_cutL_trunk_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 2250, 0, 0 } },
    { ef_f_tree4_cutL_leaf_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 3750, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_ef_f_tree4_cutL = { ARRAY_COUNT(cKF_je_r_ef_f_tree4_cutL_tbl), 2,
