...
Vtx ef_w_palm5_cutR_v[] = {
#include "assets/ef_w_palm5_cutR_v.inc"
};

Gfx ef_w_palm5_cutR_leaf_model[] = {
    gsSPDisplayList(ef_w_palm_leaf_modeset),
    gsSPVertex(ef_w_palm5_cutR_v, 32, 0),
    ...
    gsSPVertex(&ef_w_palm5_cutR_v[32], 16, 0),
...
Gfx ef_w_palm5_cutR_trunk_model[] = {
    ...
    gsSPVertex(&ef_w_palm5_cutR_v[48], 6, 0),
    gsSPNTrianglesInit_5b(4, 0, 1, 2, 0, 2, 3, 1, 4, 5),
    gsSPNTriangles_5b(1, 5, 2, 0, 0, 0, 0, 0, 0, 0, 0, 0),
    gsSPEndDisplayList(),
};

cKF_Joint_R_c cKF_je_r_ef_w_palm5_cutR_tbl[] = {
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 1000, 0, 0 } },
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { ef_w_palm5_cutR_trunk_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 2250, 0, 0 } },
    { ef_w_palm5_cutR_leaf_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 4750, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_ef_w_palm5_cutR = { ARRAY_COUNT(cKF_je_r_ef_w_palm5_cutR_tbl), 2,
                                              cKF_je_r_ef_w_palm5_cutR_tbl };
