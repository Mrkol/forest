...
u16 int_nog_collegenote_pal[] ATTRIBUTE_ALIGN(32) = {
#include "assets/int_nog_collegenote_pal.inc"
};

u8 int_nog_collegenote_tex[] = {
#include "assets/int_nog_collegenote_tex.inc"
};

Vtx int_nog_collegenote_v[] = {
...
Gfx int_nog_collegenote_model[] = {
    ...
    gsDPLoadTLUT_Dolphin(15, 16, 1, int_nog_collegenote_pal),
    gsDPSetTextureImage_Dolphin(G_IM_FMT_CI, G_IM_SIZ_4b, 64, 32, int_nog_collegenote_tex),
    gsDPSetTile_Dolphin(G_DOLPHIN_TLUT_DEFAULT_MODE, 0, 15, GX_MIRROR, GX_MIRROR, 0, 0),
    gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH | G_DECAL_LEQUAL),
    gsSPVertex(int_nog_collegenote_v, 32, 0),
    ...
    gsSPVertex(&int_nog_collegenote_v[30], 31, 0),
