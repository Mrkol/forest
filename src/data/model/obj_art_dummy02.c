...
u16 obj_art_dummy02_pal[] = {
#include "assets/obj_art_dummy02_pal.inc"
};

u8 obj_art_dummy02_tex[] = {
#include "assets/obj_art_dummy02_tex.inc"
};

u8 obj_art_dummy02_back_tex[] = {
#include "assets/obj_art_dummy02_back_tex.inc"
};

u8 obj_art_dummy02_name_tex[] = {
#include "assets/obj_art_dummy02_name_tex.inc"
};

Vtx obj_art_dummy02_v[] = {
#include "assets/obj_art_dummy02_v.inc"
};

Gfx obj_art_dummy02_model[] = {
    gsSPTexture(65535, 65535, 0, G_TX_RENDERTILE, G_ON),
    gsDPPipeSync(),
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPSetTextureLUT(G_TT_RGBA16),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, obj_art_dummy02_pal),
    gsDPTileSync(),
    ...
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, obj_art_dummy02_name_tex),
    ...
    gsSPVertex(obj_art_dummy02_v, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, obj_art_dummy02_back_tex),
    ...
    gsSPVertex(&obj_art_dummy02_v[4], 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, obj_art_dummy02_tex),
    ...
    gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 1, 0, G_TX_RENDERTILE, 15, G_TX_NOMIRROR | G_TX_WRAP, 4, G_TX_NOLOD,
                G_TX_MIRROR | G_TX_CLAMP, 4, G_TX_NOLOD),
    gsDPSetTileSize(G_TX_RENDERTILE, 0, 0, 60, 60),
    gsSPVertex(&obj_art_dummy02_v[8], 22, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
