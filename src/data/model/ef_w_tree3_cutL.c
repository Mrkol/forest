...
Vtx ef_w_tree3_cutL_v[] = {
#include "assets/ef_w_tree3_cutL_v.inc"
};

Gfx ef_w_tree3_cutL_leaf_model[] = {
...
Gfx ef_w_tree3_cutL_trunk_model[] = {
...
cKF_Skeleton_R_c cKF_bs_r_ef_w_tree3_cutL = { ARRAY_COUNT(cKF_je_r_ef_w_tree3_cutL_tbl), 2,
                                              cKF_je_r_ef_w_tree3_cutL_tbl };
