...
Vtx ef_s_tree4_cutL_v[] = {
#include "assets/ef_s_tree4_cutL_v.inc"
};

Gfx ef_s_tree4_cutL_leaf_model[] = {
    gsSPDisplayList(ef_s_tree_leaf_modeset),
    gsSPVertex(ef_s_tree4_cutL_v, 10, 0),
...
Gfx ef_s_tree4_cutL_trunk_model[] = {
    ...
    gsSPVertex(&ef_s_tree4_cutL_v[10], 6, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 3, 1, 0),
    gsSP2Triangles(2, 1, 4, 0, 1, 5, 4, 0),
    gsSPEndDisplayList(),
};

cKF_Joint_R_c cKF_je_r_ef_s_tree4_cutL_tbl[] = {
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { -750, 0, 0 } },
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { ef_s_tree4_cutL_trunk_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 2250, 0, 0 } },
    { ef_s_tree4_cutL_leaf_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 3750, 0, 0 } }
};
