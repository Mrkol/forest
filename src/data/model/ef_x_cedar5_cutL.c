...
Vtx ef_x_cedar5_cutL_v[] = {
#include "assets/ef_x_cedar5_cutL_v.inc"
};

Gfx ef_x_cedar5_cutL_light_model[] = {
    gsSPDisplayList(ef_w_cedar_light_modeset),
    gsSPVertex(&ef_x_cedar5_cutL_v[68], 26, 0),
...
Gfx ef_x_cedar5_cutL_leaf_model[] = {
    gsSPDisplayList(ef_w_cedar_leaf_modeset),
    gsSPVertex(ef_x_cedar5_cutL_v, 32, 0),
    ...
    gsSPVertex(&ef_x_cedar5_cutL_v[32], 32, 0),
    ...
    gsSPVertex(&ef_x_cedar5_cutL_v[62], 6, 0),
    gsSPNTrianglesInit_5b(2, 0, 1, 2, 3, 4, 5, 0, 0, 0),
    gsSPEndDisplayList(),
};

Gfx ef_x_cedar5_cutL_trunk_model[] = {
    ...
    gsSPVertex(&ef_x_cedar5_cutL_v[94], 6, 0),
    gsSPNTrianglesInit_5b(4, 0, 1, 2, 1, 3, 2, 1, 4, 3),
    gsSPNTriangles_5b(1, 5, 4, 0, 0, 0, 0, 0, 0, 0, 0, 0),
    gsSPEndDisplayList(),
};

cKF_Joint_R_c cKF_je_r_ef_x_cedar5_cutL_tbl[] = {
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { -1000, 0, 0 } },
    { NULL, 1, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } },
    { ef_x_cedar5_cutL_trunk_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 2250, 0, 0 } },
    { ef_x_cedar5_cutL_leaf_model, 1, cKF_JOINT_FLAG_DISP_OPA, { 6750, 0, 0 } },
    { ef_x_cedar5_cutL_light_model, 0, cKF_JOINT_FLAG_DISP_OPA, { 0, 0, 0 } }
};

cKF_Skeleton_R_c cKF_bs_r_ef_x_cedar5_cutL = { ARRAY_COUNT(cKF_je_r_ef_x_cedar5_cutL_tbl), 3,
                                               cKF_je_r_ef_x_cedar5_cutL_tbl };
