...
u16 obj_art05_pal[] = {
#include "assets/obj_art05_pal.inc"
};

u8 obj_art05_art_tex[] = {
#include "assets/obj_art05_art_tex.inc"
};

u8 obj_art05_gaku_tex[] = {
#include "assets/obj_art05_gaku_tex.inc"
};

u8 obj_art05_name_tex[] = {
#include "assets/obj_art05_name_tex.inc"
};

Vtx obj_art05_v[] = {
#include "assets/obj_art05_v.inc"
};
...
Gfx obj_art05_model[] = {
    ...
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, obj_art05_pal),
    gsDPTileSync(),
    ...
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, obj_art05_name_tex),
    ...
    gsSPVertex(obj_art05_v, 4, 0),
    gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, obj_art05_gaku_tex),
    ...
    gsDPPipeSync(),
    gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, obj_art05_art_tex),
