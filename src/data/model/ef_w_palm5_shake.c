...
Gfx ef_w_palm5_shake_model[] = {
    ...
    gsSPVertex(&ef_w_palm5_shake_v[32], 16, 0),
...
cKF_Skeleton_R_c cKF_bs_r_ef_w_palm5_shake = { ARRAY_COUNT(cKF_je_r_ef_w_palm5_shake_tbl), 1,
                                               cKF_je_r_ef_w_palm5_shake_tbl };
