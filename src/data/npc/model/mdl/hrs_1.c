...
static Gfx head_hrs_model[] = {
    ...
    gsDPLoadTextureBlock_4b_Dolphin(anime_4_txt + 0x480, G_IM_FMT_CI, 16, 16, 15, GX_MIRROR, GX_CLAMP, 0, 0),
    ...
    gsSPNTriangles_5b(12, 16, 10, // tri0
                      0, 0, 0,    // tri1
                      0, 0, 0,    // tri2
                      0, 0, 0     // tri3
                      ),
    ...
    gsDPLoadTextureBlock_4b_Dolphin(anime_4_txt + 0x240, G_IM_FMT_CI, 32, 32, 15, GX_CLAMP, GX_CLAMP, 0, 0),
    ...
    gsSPNTriangles_5b(18, 25, 26, // tri0
                      14, 1, 5,   // tri1
                      11, 10, 18, // tri2
                      19, 10, 23  // tri3
                      ),
    ...
    gsSPNTriangles_5b(11, 4, 13, // tri0
                      1, 0, 6,   // tri1
                      11, 5, 4,  // tri2
                      0, 0, 0    // tri3
                      ),
...
static Gfx mouth_hrs_model[] = {
    ...
    gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
    gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
    gsDPLoadTextureBlock_4b_Dolphin(anime_4_txt + 0x000, G_IM_FMT_CI, 16, 16, 15, GX_MIRROR, GX_CLAMP, 0, 0),
    gsDPSetTileSize(0, 0, 0, 124, 60),
    gsDPSetPrimColor(0, 128, 255, 255, 255, 255),
    ...
    gsSPNTriangles_5b(18, 23, 16, // tri0
                      0, 0, 0,    // tri1
                      0, 0, 0,    // tri2
                      0, 0, 0     // tri3
                      ),
...
static Gfx chest_hrs_model[] = {
    ...
    gsSPNTriangles_5b(11, 10, 5, // tri0
                      11, 5, 4,  // tri1
                      1, 13, 2,  // tri2
                      3, 2, 9    // tri3
                      ),
...
cKF_Skeleton_R_c cKF_bs_r_hrs_1 = { 26, 14, cKF_je_r_hrs_1_tbl };
