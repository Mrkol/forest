...
static Vtx grd_s_o_r1_5_v[] = {
#include "assets/field/bg/grd_s_o_r1_5_v.inc"
};

Gfx grd_s_o_r1_5_model[] = {
    ...
    gsSPVertex(&grd_s_o_r1_5_v[0], 15, 0),
...
Gfx grd_s_o_r1_5_modelT[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_o_r1_5_v[15], 29, 0),
    gsSPNTrianglesInit_5b(
        31, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
