...
static Vtx grd_s_e3_o_1_v[] = {
#include "assets/field/bg/grd_s_e3_o_1_v.inc"
};

Gfx grd_s_e3_o_1_model[] = {
    ...
    gsSPVertex(&grd_s_e3_o_1_v[0], 15, 0),
...
Gfx grd_s_e3_o_1_modelT[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_e3_o_1_v[15], 15, 0),
    gsSPNTrianglesInit_5b(
        16, // tri count
        0, 1, 2, // tri0
        2, 3, 0, // tri1
