...
static Vtx grd_s_c5_r2_1_v[] = {
#include "assets/field/bg/grd_s_c5_r2_1_v.inc"
};

Gfx grd_s_c5_r2_1_modelT[] = {
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[293], 19, 0),
    ...
    gsSPNTriangles_5b(4, 14, 16, // tri0
                      8, 15, 10, // tri1
                      15, 6, 10, // tri2
                      17, 7, 18  // tri3
                      ),
...
Gfx grd_s_c5_r2_1_model[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_c5_r2_1_v[279], 14, 0),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[0], 32, 0),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[32], 32, 0),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[64], 32, 0),
    ...
    gsSPNTriangles_5b(25, 10, 26, // tri0
                      10, 11, 26, // tri1
                      7, 11, 8,   // tri2
                      27, 28, 29  // tri3
                      ),
    gsSPVertex(&grd_s_c5_r2_1_v[94], 22, 0),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[116], 32, 0),
    ...
    gsSPNTriangles_5b(31, 30, 27, // tri0
                      0, 0, 0,    // tri1
                      0, 0, 0,    // tri2
                      0, 0, 0     // tri3
                      ),
    gsSPVertex(&grd_s_c5_r2_1_v[148], 20, 0),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[168], 32, 0),
    gsSPNTrianglesInit_5b(18,      // tri count
                          0, 1, 2, // tri0
                          0, 3, 1, // tri1
                          4, 5, 6  // tri2
    ...
    gsSPNTriangles_5b(20, 19, 6, // tri0
                      3, 21, 1,  // tri1
                      3, 22, 21, // tri2
                      23, 10, 24 // tri3
                      ),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[198], 14, 0),
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[212], 14, 0),
    gsSPNTrianglesInit_5b(8,       // tri count
                          0, 1, 2, // tri0
                          0, 3, 1, // tri1
                          4, 5, 6  // tri2
    ...
    gsSPVertex(&grd_s_c5_r2_1_v[226], 32, 0),
    ...
    gsSPNTriangles_5b(2, 15, 13,  // tri0
                      16, 17, 18, // tri1
                      16, 19, 17, // tri2
                      19, 20, 17  // tri3
                      ),
    gsSPNTriangles_5b(8, 21, 9,   // tri0
                      21, 22, 9,  // tri1
                      21, 18, 22, // tri2
                      18, 23, 16  // tri3
                      ),
    gsSPNTriangles_5b(14, 20, 24, // tri0
                      20, 19, 24, // tri1
                      2, 25, 26,  // tri2
                      25, 27, 26  // tri3
                      ),
    gsSPNTriangles_5b(15, 2, 26,  // tri0
                      21, 23, 18, // tri1
                      28, 25, 29, // tri2
                      28, 30, 25  // tri3
                      ),
    gsSPNTriangles_5b(25, 2, 29, // tri0
                      2, 4, 29,  // tri1
                      0, 31, 3,  // tri2
                      0, 11, 31  // tri3
                      ),
    gsSPNTriangles_5b(11, 24, 31, // tri0
                      0, 0, 0,    // tri1
                      0, 0, 0,    // tri2
                      0, 0, 0     // tri3
                      ),
    gsSPVertex(&grd_s_c5_r2_1_v[258], 21, 0),
    ...
    gsSPNTriangles_5b(19, 0, 20, // tri0
                      0, 0, 0,   // tri1
                      0, 0, 0,   // tri2
                      0, 0, 0    // tri3
                      ),
