...
static Vtx grd_s_r2_2_v[] = {
#include "assets/field/bg/grd_s_r2_2_v.inc"
};

Gfx grd_s_r2_2_modelT[] = {
    ...
    gsSPVertex(&grd_s_r2_2_v[182], 13, 0),
...
Gfx grd_s_r2_2_model[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_r2_2_v[0], 32, 0),
    ...
    gsSPNTriangles_5b(16, 12, 14, // tri0
                      17, 18, 19, // tri1
                      17, 20, 18, // tri2
                      18, 21, 19  // tri3
                      ),
    ...
    gsSPNTriangles_5b(6, 24, 10,  // tri0
                      27, 28, 29, // tri1
                      27, 30, 28, // tri2
                      28, 31, 29  // tri3
                      ),
    gsSPVertex(&grd_s_r2_2_v[32], 32, 0),
    ...
    gsSPNTriangles_5b(14, 30, 13, // tri0
                      14, 31, 30, // tri1
                      14, 25, 31, // tri2
                      25, 26, 31  // tri3
                      ),
    gsSPVertex(&grd_s_r2_2_v[64], 7, 0),
    ...
    gsSPVertex(&grd_s_r2_2_v[71], 32, 0),
    gsSPNTrianglesInit_5b(19,      // tri count
                          0, 1, 2, // tri0
                          0, 3, 1, // tri1
                          0, 4, 3  // tri2
    ...
    gsSPVertex(&grd_s_r2_2_v[103], 32, 0),
    ...
    gsSPVertex(&grd_s_r2_2_v[135], 32, 0),
    ...
    gsSPVertex(&grd_s_r2_2_v[165], 17, 0),
    gsSPNTrianglesInit_5b(11,      // tri count
                          0, 1, 2, // tri0
                          1, 3, 2, // tri1
                          3, 4, 2  // tri2
