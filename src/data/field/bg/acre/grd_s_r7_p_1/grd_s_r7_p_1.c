...
static Vtx grd_s_r7_p_1_v[] = {
#include "assets/field/bg/grd_s_r7_p_1_v.inc"
};

Gfx grd_s_r7_p_1_modelT[] = {
    ...
    gsSPVertex(&grd_s_r7_p_1_v[256], 17, 0),
    ...
    gsSPNTriangles_5b(9, 3, 6,   // tri0
                      10, 9, 6,  // tri1
                      11, 10, 6, // tri2
                      12, 11, 6  // tri3
                      ),
    gsSPNTriangles_5b(13, 12, 6, // tri0
                      14, 13, 6, // tri1
                      14, 6, 5,  // tri2
                      15, 14, 5  // tri3
                      ),
...
Gfx grd_s_r7_p_1_model[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_r7_p_1_v[218], 32, 0),
    ...
    gsSPVertex(&grd_s_r7_p_1_v[248], 8, 0),
    ...
    gsSPVertex(&grd_s_r7_p_1_v[0], 32, 0),
    ...
    gsSPNTriangles_5b(7, 13, 8,   // tri0
                      9, 11, 7,   // tri1
                      19, 20, 21, // tri2
                      1, 6, 3     // tri3
                      ),
    gsSPNTriangles_5b(0, 22, 1,  // tri0
                      0, 23, 22, // tri1
                      4, 6, 24,  // tri2
                      5, 17, 3   // tri3
                      ),
    gsSPNTriangles_5b(5, 18, 17,  // tri0
                      25, 26, 27, // tri1
                      25, 28, 26, // tri2
                      25, 29, 28  // tri3
                      ),
    gsSPNTriangles_5b(30, 31, 25, // tri0
                      31, 29, 25, // tri1
                      0, 0, 0,    // tri2
                      0, 0, 0     // tri3
                      ),
    gsSPVertex(&grd_s_r7_p_1_v[32], 28, 0),
    ...
    gsSPVertex(&grd_s_r7_p_1_v[60], 32, 0),
    ...
    gsSPNTriangles_5b(14, 11, 17, // tri0
                      18, 19, 20, // tri1
                      21, 22, 23, // tri2
                      22, 14, 17  // tri3
                      ),
    gsSPNTriangles_5b(19, 24, 20, // tri0
                      22, 17, 23, // tri1
                      20, 25, 26, // tri2
                      27, 28, 18  // tri3
                      ),
    gsSPNTriangles_5b(10, 29, 27, // tri0
                      5, 30, 31,  // tri1
                      0, 0, 0,    // tri2
                      0, 0, 0     // tri3
                      ),
    gsSPVertex(&grd_s_r7_p_1_v[92], 14, 0),
    gsSPNTrianglesInit_5b(6,       // tri count
                          0, 1, 2, // tri0
                          3, 4, 5, // tri1
                          6, 7, 8  // tri2
    ...
    gsSPVertex(&grd_s_r7_p_1_v[106], 32, 0),
    ...
    gsSPNTriangles_5b(19, 7, 6,   // tri0
                      20, 21, 22, // tri1
                      21, 23, 22, // tri2
                      21, 24, 23  // tri3
                      ),
    gsSPNTriangles_5b(23, 25, 22, // tri0
                      6, 5, 26,   // tri1
                      27, 5, 9,   // tri2
                      18, 28, 16  // tri3
                      ),
    ...
    gsSPNTriangles_5b(4, 31, 3, // tri0
                      0, 0, 0,  // tri1
                      0, 0, 0,  // tri2
                      0, 0, 0   // tri3
                      ),
    gsSPVertex(&grd_s_r7_p_1_v[138], 32, 0),
    gsSPNTrianglesInit_5b(22,      // tri count
                          0, 1, 2, // tri0
                          3, 4, 5, // tri1
                          4, 6, 5  // tri2
    ...
    gsSPVertex(&grd_s_r7_p_1_v[170], 32, 0),
    ...
    gsSPNTriangles_5b(21, 23, 18, // tri0
                      23, 22, 18, // tri1
                      23, 24, 22, // tri2
                      23, 25, 24  // tri3
                      ),
    ...
    gsSPVertex(&grd_s_r7_p_1_v[202], 16, 0),
