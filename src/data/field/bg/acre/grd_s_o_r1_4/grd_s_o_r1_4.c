...
static Vtx grd_s_o_r1_4_v[] = {
#include "assets/field/bg/grd_s_o_r1_4_v.inc"
};

Gfx grd_s_o_r1_4_model[] = {
    ...
    gsSPVertex(&grd_s_o_r1_4_v[0], 15, 0),
...
Gfx grd_s_o_r1_4_modelT[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_o_r1_4_v[15], 32, 0),
    gsSPNTrianglesInit_5b(
        36, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
    ...
    gsSPVertex(&grd_s_o_r1_4_v[47], 9, 0),
    gsSPNTrianglesInit_5b(
        7, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
