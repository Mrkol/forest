...
static Vtx grd_s_r3_2_v[] = {
#include "assets/field/bg/grd_s_r3_2_v.inc"
};

Gfx grd_s_r3_2_modelT[] = {
    ...
    gsSPVertex(&grd_s_r3_2_v[186], 13, 0),
...
Gfx grd_s_r3_2_model[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_r3_2_v[170], 16, 0),
    ...
    gsSPVertex(&grd_s_r3_2_v[0], 32, 0),
    ...
    gsSPVertex(&grd_s_r3_2_v[32], 6, 0),
    ...
    gsSPVertex(&grd_s_r3_2_v[38], 32, 0),
    ...
    gsSPNTriangles_5b(26, 24, 27, // tri0
                      26, 27, 28, // tri1
                      29, 26, 28, // tri2
                      29, 28, 30  // tri3
                      ),
    gsSPVertex(&grd_s_r3_2_v[69], 24, 0),
    ...
    gsSPVertex(&grd_s_r3_2_v[93], 32, 0),
    gsSPNTrianglesInit_5b(19,      // tri count
                          0, 1, 2, // tri0
                          1, 3, 2, // tri1
                          0, 4, 1  // tri2
    ...
    gsSPNTriangles_5b(7, 20, 19,  // tri0
                      12, 20, 13, // tri1
                      21, 22, 23, // tri2
                      21, 24, 22  // tri3
                      ),
    ...
    gsSPVertex(&grd_s_r3_2_v[124], 30, 0),
    gsSPNTrianglesInit_5b(19,      // tri count
                          0, 1, 2, // tri0
                          1, 3, 4, // tri1
                          3, 5, 4  // tri2
    ...
    gsSPVertex(&grd_s_r3_2_v[154], 16, 0),
    gsSPNTrianglesInit_5b(9,       // tri count
                          0, 1, 2, // tri0
                          0, 3, 1, // tri1
                          4, 5, 6  // tri2
