...
static Vtx grd_s_m_8_v[] = {
#include "assets/field/bg/grd_s_m_8_v.inc"
};
...
Gfx grd_s_m_8_model[] = {
    ...
    gsSPVertex(&grd_s_m_8_v[140], 25, 0),
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_m_8_v[127], 13, 0),
    gsSPNTrianglesInit_5b(
        6, // tri count
        0, 1, 2, // tri0
        3, 0, 4, // tri1
    ...
    gsSPVertex(&grd_s_m_8_v[23], 13, 0),
    gsSPNTrianglesInit_5b(
        9, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
    ...
    gsSPVertex(&grd_s_m_8_v[36], 28, 0),
    gsSPNTrianglesInit_5b(
        14, // tri count
        0, 1, 2, // tri0
        2, 3, 4, // tri1
    ...
    gsSPVertex(&grd_s_m_8_v[64], 32, 0),
    gsSPNTrianglesInit_5b(
        30, // tri count
        0, 1, 2, // tri0
        1, 3, 2, // tri1
    ...
    gsSPVertex(&grd_s_m_8_v[100], 13, 0),
    gsSPNTrianglesInit_5b(
        6, // tri count
        0, 1, 2, // tri0
        3, 4, 5, // tri1
    ...
    gsSPVertex(&grd_s_m_8_v[113], 14, 0),
    gsSPNTrianglesInit_5b(
        10, // tri count
        0, 1, 2, // tri0
        3, 0, 2, // tri1
...
Gfx grd_s_m_8_modelT[] = {
    ...
    gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
    gsSPVertex(&grd_s_m_8_v[165], 20, 0),
    gsSPNTrianglesInit_5b(
        19, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
    ...
    gsSPVertex(&grd_s_m_8_v[185], 24, 0),
    gsSPNTrianglesInit_5b(
        21, // tri count
        0, 1, 2, // tri0
        0, 3, 1, // tri1
