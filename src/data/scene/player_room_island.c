...
Scene_Word_u player_room_island_info[] = {
...
Actor_data PLAYER_ROOM_ISLAND_player_data[] = {
    {
...
s16 PLAYER_ROOM_ISLAND_ctrl_actor_data[] = {
...
Actor_data PLAYER_ROOM_ISLAND_actor_data[] = {
    {
...
s16 PLAYER_ROOM_ISLAND_object_bank[] = {
    ACTOR_OBJ_BANK_ROOM_SUNSHINE, // 0
    ACTOR_OBJ_BANK_HOUSE_GOKI,           // 1
};

Door_data_c PLAYER_ROOM_ISLAND_door_data[] = {
    {
