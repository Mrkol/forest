...
Scene_Word_u museum_fossil_info[] = {
...
Actor_data MUSEUM_FOSSIL_player_data[] = {
    {
...
s16 MUSEUM_FOSSIL_ctrl_actor_data[] = {
...
s16 MUSEUM_FOSSIL_object_bank[] = {
    ACTOR_OBJ_BANK_HOUSE_GOKI, // 0
};

Door_data_c MUSEUM_FOSSIL_door_data[] = {
    {
