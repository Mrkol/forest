...
Scene_Word_u npc_room_island_info[] = {
...
s16 NPC_ROOM_ISLAND_ctrl_actor_data[] = {
...
Actor_data NPC_ROOM_ISLAND_actor_data[] = {
    {
...
s16 NPC_ROOM_ISLAND_object_bank[] = {
    ACTOR_OBJ_BANK_ROOM_SUNSHINE, // 0
};

Door_data_c NPC_ROOM_ISLAND_door_data[] = {
    {
