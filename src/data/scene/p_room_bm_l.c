...
Actor_data P_ROOM_BM_L_player_data[] = {
    {
...
s16 P_ROOM_BM_L_ctrl_actor_data[] = {
...
s16 P_ROOM_BM_L_object_bank[] = {
    ACTOR_OBJ_BANK_HOUSE_GOKI, // 0
};

Door_data_c P_ROOM_BM_L_door_data[] = {
    {
