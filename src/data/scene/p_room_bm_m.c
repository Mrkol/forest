...
Actor_data P_ROOM_BM_M_player_data[] = {
    {
...
s16 P_ROOM_BM_M_ctrl_actor_data[] = {
...
s16 P_ROOM_BM_M_object_bank[] = {
    ACTOR_OBJ_BANK_HOUSE_GOKI, // 0
};

Door_data_c P_ROOM_BM_M_door_data[] = {
    {
