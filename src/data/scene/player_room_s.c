...
Scene_Word_u player_room_s_info[] = {
...
Actor_data PLAYER_ROOM_S_player_data[] = {
    {
...
s16 PLAYER_ROOM_S_ctrl_actor_data[] = {
...
Actor_data PLAYER_ROOM_S_actor_data[] = {
    {
...
s16 PLAYER_ROOM_S_object_bank[] = {
    ACTOR_OBJ_BANK_ROOM_SUNSHINE, // 0
    ACTOR_OBJ_BANK_HOUSE_GOKI,           // 1
};

Door_data_c PLAYER_ROOM_S_door_data[] = {
    {
